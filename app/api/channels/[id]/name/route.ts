...
import { requireWritableUser } from "@/lib/auth";
...
// gọi được route này (trừ tài khoản demo của reviewer TikTok, xem lib/auth.ts
// requireWritableUser()), nhưng lib/channels.ts's updateChannelName() (qua hàm SECURITY DEFINER
